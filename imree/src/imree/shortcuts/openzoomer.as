 ...
 */
public class openzoomer extends Sprite
{
    //--------------------------------------------------------------------------
    //
    //  Constructor
     ...
     * Constructor.
     */
    public function openzoomer()
    {
        // Cross-domain security
        Security.loadPolicyFile("http://imree.tcl.sc.edu/crossdomain.xml");
...
//        map.source = new VirtualEarthDescriptor()
		...
		var str:String = "<?xml version='1.0' encoding='UTF-8'?><Image TileSize='254' Overlap='1' Format='jpg' xmlns='http://schemas.microsoft.com/deepzoom/2008'><width>5349</width><height>4032</height><Size Width='5349' Height='4032'/></Image>";
		var xm:XML = new XML(str);


		map.source = new OpenZoomDescriptor("http://imree.tcl.sc.edu/media/openzoomtest/fair/", xm);
